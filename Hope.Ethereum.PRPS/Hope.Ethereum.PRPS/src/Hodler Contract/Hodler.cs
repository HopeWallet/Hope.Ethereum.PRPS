...
namespace Hope.Ethereum.PRPS
{
    ...
    {
        private const string HODLER_MAINNET = "0xe4D688Bb2d5B7F546052cB6Fef3aEd8af8AF6511";
        ...
        public Task<Output.Item> GetItem(string addressFrom, BigInteger id)
        {
        ...
        public Task<TransactionPoller> Hodl(string privateKey, BigInteger gasLimit, BigInteger gasPrice, BigInteger id, decimal lockAmount, int monthsToLock)
        {
        ...
        public Task<TransactionPoller> Release(string privateKey, BigInteger gasLimit, BigInteger gasPrice, BigInteger id)
        {
